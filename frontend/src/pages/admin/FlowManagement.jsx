    ...
    return (
        <div className="space-y-6">
            ...
            <div className="text-white">
                ...
                <p className="text-white/60 mt-2">Real-time gate monitoring with ML predictions and AI insights</p>
            </div>

            {/* Live Gate Status Display - MOVED TO TOP */}
                                                ...
                                                {gate.investigation_id && (
                                                    <>
                                                        ...
                                                        <button
                                                            ...
                                                            className="mt-2 text-blue-400 hover:text-blue-300 hover:underline text-xs"
                                                        >
            ...
            <div className="text-white mb-4">
                ...
                <p className="text-white/60 mt-2">Test individual M1 Azure Functions endpoints</p>
            </div>
